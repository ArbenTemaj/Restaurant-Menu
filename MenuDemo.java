...
public class MenuDemo implements ActionListener, ItemListener {
    ...
    public JMenuBar createMenuBar() {
        		...
        		//images
        		ImageIcon icon = createImageIcon("fork.png");
        		ImageIcon icon2 = createImageIcon("water.png");
        		ImageIcon icon3 = createImageIcon("soda.png");
        		ImageIcon icon4 = createImageIcon("smoothie.png");
        		ImageIcon icon5 = createImageIcon("coffee.png");
        		ImageIcon icon6 = createImageIcon("Hot Chocolate.png");
        		ImageIcon icon7 = createImageIcon("Tea.png");
        		ImageIcon icon8 = createImageIcon("water with ice.png");
        		ImageIcon icon9 = createImageIcon("wine.png");
        		ImageIcon icon10 = createImageIcon("beer.png");
        		ImageIcon icon11 = createImageIcon("liqueur.png");
    ...
    public void actionPerformed(ActionEvent e) {
        	...
        	if(source.getText().equals("Coffee with Sugar - " + with_sugar.cost())){
                ...
                context.executeStrategy(with_sugar);        
        	}
    ...
    protected static void createAndShowGUI() {
        	JFrame frame = new JFrame("Resaurant");
